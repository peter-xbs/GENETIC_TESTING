...
# -----------------------bwa > samtools > picard ------------------------------------
# mapping and sort
bwa_cmd = "/opt/songchun/02_soft/bwa-0.7.17/bwa mem -t 2 -R '@RG\\tID:{}\\tSM:{}\\tPU:{}\\tLB:{}\\tPL:{}' -M {} {} {} 2>{}|samtools view -bS -o ./test2.bam".format(patient_id, patient_id, PU, LB, PL, my_config['hgRef']+'/'+'hg19', fq_2, fq_2, env_conf['bwa_log']) #|samtools sort -T {} -O BAM  -o {}/2-MAPPING/{}.{}.sorted.bam 2>{} 1>&2".format(patient_id, patient_id, PU, LB, PL, '/opt/songchun/01_ref/ucsc.hg19.fasta', fq_2, fq_2, env_conf['bwa_log'], tmp_dir+'/'+env_conf['SM']+'.'+env_conf['lane'], out_path, patient_id, lane_id, env_conf['bwa_log'])
os.system(bwa_cmd)
